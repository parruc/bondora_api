...
class ApiResultBids(object):
    ...
    def __init__(self, page_size=None, page_nr=None, total_count=None, count=None, payload=None, success=None, errors=None):
        """
        ApiResultBids - a model defined in Swagger
    ...
    def page_size(self):
        """
        Gets the page_size of this ApiResultBids.
        Requested Max items in result

        :return: The page_size of this ApiResultBids.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        """
        Sets the page_size of this ApiResultBids.
        Requested Max items in result

        :param page_size: The page_size of this ApiResultBids.
        :type: int
        """
    ...
    def page_nr(self):
        """
        Gets the page_nr of this ApiResultBids.
        Requested page nr

        :return: The page_nr of this ApiResultBids.
        :rtype: int
        """
    ...
    def page_nr(self, page_nr):
        """
        Sets the page_nr of this ApiResultBids.
        Requested page nr

        :param page_nr: The page_nr of this ApiResultBids.
        :type: int
        """
    ...
    def total_count(self):
        """
        Gets the total_count of this ApiResultBids.
        Total number of items found

        :return: The total_count of this ApiResultBids.
        :rtype: int
        """
    ...
    def total_count(self, total_count):
        """
        Sets the total_count of this ApiResultBids.
        Total number of items found

        :param total_count: The total_count of this ApiResultBids.
        :type: int
        """
    ...
    def count(self):
        """
        Gets the count of this ApiResultBids.
        Number of items returned

        :return: The count of this ApiResultBids.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """
        Sets the count of this ApiResultBids.
        Number of items returned

        :param count: The count of this ApiResultBids.
        :type: int
        """
    ...
    def payload(self):
        """
        Gets the payload of this ApiResultBids.
        The payload of the response. Type depends on the API request.

        :return: The payload of this ApiResultBids.
        :rtype: list[BidSummary]
        """
    ...
    def payload(self, payload):
        """
        Sets the payload of this ApiResultBids.
        The payload of the response. Type depends on the API request.

        :param payload: The payload of this ApiResultBids.
        :type: list[BidSummary]
        """
    ...
    def success(self, success):
        """
        Sets the success of this ApiResultBids.
        Indicates if the request was successfull or not.              true if the request was handled successfully, false otherwise.

        :param success: The success of this ApiResultBids.
        :type: bool
        """
    ...
    def errors(self):
        """
        Gets the errors of this ApiResultBids.
        Error(s) accociated with the API request.

        :return: The errors of this ApiResultBids.
        :rtype: list[ApiError]
        """
        return self._errors
    ...
    def errors(self, errors):
        """
        Sets the errors of this ApiResultBids.
        Error(s) accociated with the API request.

        :param errors: The errors of this ApiResultBids.
        :type: list[ApiError]
        """
